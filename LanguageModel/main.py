...
writer = SummaryWriter(os.path.join('exp', f'{args.model}',
                                    f'{args.model}_{args.emsize}_{args.nhid}_{args.nlayers}_{args.lr}_'
...
save_dir = os.path.join(os.path.join('model', f'{args.model}',
                                     f'{args.model}_{args.emsize}_{args.nhid}_{args.nlayers}_{args.lr}_'
                                     f'{args.batch_size}_{args.bptt}_{args.dropout}_{args.nhead}_{args.epochs}'))
...
writer.add_scalar('Test PPL', math.exp(test_loss))
writer.add_hparams({'model': args.model, 'emsize': args.emsize, 'nhid': args.nhid, 'nlayers': args.nlayers,
